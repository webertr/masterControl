...
/* Generated from ../O.Common/MasterBumpless314.dbd */
...
int MasterBumpless314_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/cnts/epics-3.14.11/operations/opIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"MasterBumpless314_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    MasterBumpless314_registerRecordDeviceDriver(*iocshPpdbbase);
}
